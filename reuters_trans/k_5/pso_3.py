import numpy as np
# import functions
from classifying_docs_3 import ClassifyingDocs
import datetime
...
if __name__ == '__main__':
    ...
    np.savetxt("best_evals_3.csv", best_evals, delimiter=",", fmt=('%s'))
    np.savetxt("best_global_solutions_3.csv", global_solutions, delimiter=",", fmt=('%s'))
    np.savetxt("best_pos_par_3.csv", particles, delimiter=",", fmt=('%s'))
    print(datetime.datetime.now())
